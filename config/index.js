export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: wx7513c2e23d126135,
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 11d33a58863dea30d32d3d29b7827ceb,
  ...
  USERS: [
    {
      ...
      id: oE3U56zAG4pLKD3nZdhK5jqnTRnY,
      // 你想对他发送的模板消息的模板ID
      useTemplateId: XlolZDUbzTW2u3Ihdtx1r0ozWjjAPMqyKZWqCx3UFOQ,
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
